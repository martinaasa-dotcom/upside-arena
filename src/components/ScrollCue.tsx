...
export function ScrollCue({
  ...
  useEffect(() => {
    ...
    /*
      ...
      button fills in where a 44px space was, and any of that can move the
      sample card across the line this is testing. Measured on Upside Lab,
      whose landing mounts a whole screen later than Arena's, the card sat
      11px clear of the band, which is well inside what a font swap moves,
      and the cue stayed hidden on a window that wanted it.
