 ...
 *
 * The field is a pair of very low alpha lobes on a true black page, so the
 * whole ramp is spent in the bottom of the range: about thirty luminance
 ...
 * wide is not a gradient, it is a contour line. That is the ringing in
 * both corners of every page here, and no amount of re-shaping the stops
 * fixes it: the levels are not there to be spent. Arena's lobes are two
 * stop ramps, colour straight to transparent, so they had it worse than
 * Lab's did. Measured and fixed there first, same filter, same numbers,
 * because the two apps are one design.
 *
 ...
 * and `.ambient-glow`), and the filter itself has to live in the document:
