/*
  ...
  milestone. Migration 0032 replaces it, and `scripts/migration-state.py` had
  to learn to read a function body before it could: a migration that creates
  nothing new is invisible to a checker that judges by presence. See
  `tests/unit/migration-state.test.ts`.
...
/*
  ...
  0032 redefines the function on top of it. This is an exception list, never a
