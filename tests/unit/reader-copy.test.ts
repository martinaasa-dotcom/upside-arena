...
/*
  ...
  app's whole voice is a person explaining their own game. Arena has no
  model-written copy at all, so every sentence in it is hand-written and
  none of it had a guard.
...
const ALLOWED = new Map<string, string>([
  [
    "src/lib/brand/mono-subset.ts",
    "Names the characters in a Unicode block so the subsetter keeps them in the font. The list documents what the font includes; it is never rendered as a sentence.",
  ],
]);
